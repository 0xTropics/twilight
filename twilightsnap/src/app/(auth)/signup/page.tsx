      ...
      <main className="flex min-h-[100dvh] items-center justify-center px-4">
        ...
        >
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 text-center backdrop-blur-sm">
            <div className="mx-auto mb-4 inline-flex rounded-full border border-green-500/20 bg-green-500/5 p-3">
            ...
            <Link
              href="/login"
              className="mt-6 inline-block text-sm font-medium text-[#c8a55c] transition-colors duration-300 hover:text-[#e8d5a3]"
            >
              Back to sign in
            </Link>
          </div>
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 backdrop-blur-sm">
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-zinc-500">
              Start transforming your property photos
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="fullName" className="premium-label">
                Full Name
              </label>
              <input
                id="fullName"
